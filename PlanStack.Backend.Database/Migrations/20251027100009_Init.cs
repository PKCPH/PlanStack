    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BuildingStructures", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Standards_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "BlueprintBuildingStructures",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlueprintBuildingStructures", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlueprintComponents", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlueprintStandards", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlueprintBuildingStructures_BlueprintId",
                table: "BlueprintBuildingStructures",
                column: "BlueprintId");

            migrationBuilder.CreateIndex(
                name: "IX_BlueprintBuildingStructures_BuildingStructureId",
                table: "BlueprintBuildingStructures",
                column: "BuildingStructureId");

            migrationBuilder.CreateIndex(
                name: "IX_BlueprintComponents_BlueprintId",
                table: "BlueprintComponents",
                column: "BlueprintId");

            migrationBuilder.CreateIndex(
                name: "IX_BlueprintComponents_ComponentId",
                table: "BlueprintComponents",
                column: "ComponentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlueprintStandards_BlueprintId",
                table: "BlueprintStandards",
                column: "BlueprintId");

            migrationBuilder.CreateIndex(
                name: "IX_BlueprintStandards_StandardId",
                table: "BlueprintStandards",
                column: "StandardId");
