...
namespace PlanStack.Backend.Database.Migrations
{
    ...
    [Migration("20251104142635_BlueprintUpdate2")]
    partial class BlueprintUpdate2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlanStack.Backend.Database.DataModels.BSBlueprintPosition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("BlueprintBuildingStructureId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BlueprintBuildingStructureId");

                    b.ToTable("BSBlueprintPosition");
                });
            ...
            modelBuilder.Entity("PlanStack.Backend.Database.DataModels.CBlueprintPosition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PlanStack.Backend.Database.DataModels.BSBlueprintPosition", b =>
                {
                    b.HasOne("PlanStack.Backend.Database.DataModels.BlueprintBuildingStructure", "BlueprintBuildingStructure")
                        .WithMany("Positions")
                        .HasForeignKey("BlueprintBuildingStructureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BlueprintBuildingStructure");
                });
            ...
            modelBuilder.Entity("PlanStack.Backend.Database.DataModels.CBlueprintPosition", b =>
                {
                    b.HasOne("PlanStack.Backend.Database.DataModels.BlueprintComponent", "BlueprintComponent")
                        .WithMany("Positions")
                        .HasForeignKey("BlueprintComponentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BlueprintComponent");
                });
